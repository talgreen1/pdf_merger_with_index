...
WORD_FOOTER_LEFT_TEXT = 'נערך ע"י טל גרין, 2026'
WORD_FOOTER_RIGHT_TEXT = "רגע של אור - ספר שירים"
WORD_FOOTER_LEFT_TEXT_FONT_SIZE_PT = 8
WORD_FOOTER_RIGHT_TEXT_FONT_SIZE_PT = 8
...
if book_config_path.exists():
    ...
    generate_manifest_songbook(
        ...
        word_footer_left_text=WORD_FOOTER_LEFT_TEXT,
        word_footer_right_text=WORD_FOOTER_RIGHT_TEXT,
        word_footer_left_text_font_size_pt=WORD_FOOTER_LEFT_TEXT_FONT_SIZE_PT,
        word_footer_right_text_font_size_pt=WORD_FOOTER_RIGHT_TEXT_FONT_SIZE_PT,
